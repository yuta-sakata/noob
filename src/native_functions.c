...
void registerAllNativeFunctions(Interpreter *interpreter)
{
    ...
    // 基础函数
    registerNativeFunction(interpreter, "ta-yin", -1, printNative);
    registerNativeFunction(interpreter, "ta-yin-hang", -1, printlnNative);
    registerNativeFunction(interpreter, "shih-chung", 0, clockNative);
    registerNativeFunction(interpreter, "lei-hsing", 1, typeNative);
    registerNativeFunction(interpreter, "shu-ju", -1, inputNative);

    // 数组相关函数
    registerNativeFunction(interpreter, "chang-tu", 1, lengthNative);
    registerNativeFunction(interpreter, "tui", 2, pushNative);
    registerNativeFunction(interpreter, "tan", 1, popNative);
    registerNativeFunction(interpreter, "tan-shu-tsu", 1, popArrayNative);
    registerNativeFunction(interpreter, "chieh-pien", -1, sliceNative); // -1表示可变参数（2或3个）
