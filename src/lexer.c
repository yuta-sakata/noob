...
static Keyword keywords[] = {
    {"ju", 2, TOKEN_IF},
    {"fou-tse", 7, TOKEN_ELSE},
    {"tsai", 4, TOKEN_IN},
    {"tang", 4, TOKEN_WHILE},
    {"wei", 3, TOKEN_FOR},
    {"tso", 3, TOKEN_DO},
    {"fan-hui", 7, TOKEN_RETURN},
    {"han-shu", 7, TOKEN_FUNCTION},
    {"pien-liang", 10, TOKEN_VAR},
    {"kai-kuan", 8, TOKEN_SWITCH},
    {"an-li", 5, TOKEN_CASE},
    {"mo-jen", 6, TOKEN_DEFAULT},
    {"po", 2, TOKEN_BREAK},
    {"heng", 4, TOKEN_CONST},
    {"ching", 5, TOKEN_STATIC},
    {"kung", 4, TOKEN_VOID},
    {"cheng", 5, TOKEN_INT},
    {"fu", 2, TOKEN_FLOAT_TYPE},
    {"shuang", 6, TOKEN_DOUBLE},
    {"chuang", 6, TOKEN_STRING_TYPE},
    {"pu", 2, TOKEN_BOOL},
    {"tao", 3, TOKEN_IMPORT},
    {"wu", 2, TOKEN_NULL},
    {"chen", 4, TOKEN_TRUE},
    {"chia", 4, TOKEN_FALSE},
    {"mei-chu", 7, TOKEN_ENUM},
    {"chieh-kou", 9, TOKEN_STRUCT},
